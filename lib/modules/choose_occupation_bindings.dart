...
class ChooseOccupation extends StatelessWidget {
  ChooseOccupation({super.key});
        ...
        child: Obx(
          () => Column(
            ...
            children: [
              ...
              32.0.h.spacingH,
              Column(
                children: List.generate(state.occupation.length, (index) {
                  return Row(
                    children: [
                      Radio(
