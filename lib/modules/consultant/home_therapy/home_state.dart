...
class ConsultantHomeState {
  ConsultantHomeState();
  // final List<ServiceItem> serviceItems = [
  //   ServiceItem(title: 'Airtime', iconPath: 'images/Airtime.png'),
  //   ServiceItem(title: 'Data', iconPath: 'images/Data.png'),
  //   ServiceItem(title: 'Electricit', iconPath: 'images/Elect.png'),
  //   ServiceItem(title: 'More', iconPath: 'images/Group.png'),
  // ];
  ...
  List<ArticleModel> article = [
    ArticleModel(
        title: 'We’re Missing the Good News About Youth Mental Health',
